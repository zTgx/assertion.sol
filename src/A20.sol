...
contract A20 is DynamicAssertion {
        ...
        returns (string memory, string memory, string[] memory, string memory, bool)
    {
        ...
        schema_url =
            "https://raw.githubusercontent.com/litentry/vc-jsonschema/main/dist/schemas/12-idhub-evm-version-early-bird/1-0-0.json";
        bool result = false;
        ...
        for (uint256 i = 0; i < identities.length; i++) {
            if (is_web3(identities[i])) {
                ...
                string memory url =
                    concatenateStrings("http://localhost:19527/events/does-user-joined-evm-campaign?account=", res);
